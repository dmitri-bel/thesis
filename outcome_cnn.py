...
parser = argparse.ArgumentParser(description="CNN - Process Outcome Prediction.")
...
parser.add_argument("--model", default="cnn", type=str, help="description model")
...
if __name__ == "__main__":
    ...
    if not is_existing:
        ...
        # --train new model
        transformer_model = transformer.get_outcome_cnn_model(
